...
data class ConversationEntity(
    ...
    @ColumnInfo(name = "last_message") val lastMessage: String = "" // Added for Drawer Preview
)
...
data class MessageEntity(
    ...
    @ColumnInfo(name = "status") val status: MessageStatus = MessageStatus.SENT, // Added
    
    @ColumnInfo(name = "edited") val edited: Boolean = false // Added
)
