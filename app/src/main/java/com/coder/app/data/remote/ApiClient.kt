package com.coder.app.data.remote

import com.coder.app.data.model.ChatRequest
import com.coder.app.data.model.ChatResponse
import com.coder.app.data.model.ChatStreamChunk
        ...
        .addInterceptor { chain ->
            chain.proceed(
                chain.request().newBuilder()
                    ...
                    .header("User-Agent", "AIChatApp/1.0")
